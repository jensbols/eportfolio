  ...
  return (
    <>
      <div className="max-w-7xl mx-auto flex pt-6 pb-20 px-32 bg-transparent">
        ...
        {/* left */}
        <div className="text-center mt-20 ml-10">
          <h3 className='text-3xl font-bold text-center pt-3 border-b-4 border-blue-500 pb-3'>About me</h3>
          <p className='mt-6 pb-6 border-b-4 border-blue-500'>I always had a hard time figuring out what I wanted to become in life, It wasn't until I enrolled in a computer course at my local highschool in Oostende that I found something that sparked my interest.
